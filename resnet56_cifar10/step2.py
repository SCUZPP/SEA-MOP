...
def get_population(model, args, train_loader, test_loader, val_loader):
    ...
    if args.depth == 56:
        p0 = []
        original_filter = pickle.load(open('filter_dict/filter_dict_resnet56.pkl', 'rb'))
        p = pickle.load(open('population_dict/population_dict_resnet56_p0.pkl', 'rb'))
        p0.append(p[0])
        target_dir = 'Results2_resnet56/'
