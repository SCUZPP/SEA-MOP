...
class BasicBlock(nn.Module):
    ...
    def __init__(self, fp, inplanes, planes, stride=1, downsample=None):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = []
        layers.append(block(self.fp, self.inplanes, planes, stride, downsample))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(block(self.fp, self.inplanes, planes))
