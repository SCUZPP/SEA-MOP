...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.bn1(out)
        out = self.relu(out)
        self.res1.append(out)

        out = self.conv2(out)
        out = self.bn2(out)
        self.res2.append(out)
        ...
        return out, self.res1, self.res2
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x, res1, res2 = self.layer1(x)  # 32x32
        self.feature_map.append(res1, res2)
        
        x, res1, res2 = self.layer2(x)  # 16x16
        self.feature_map.append(res1, res2)
        
        x, res1, res2 = self.layer3(x)  # 8x8
        self.feature_map.append(res1, res2)
