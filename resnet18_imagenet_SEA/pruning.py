...
def prune_model(model_original, solution, args):
    ...
    for [m0, m1] in zip(model.modules(), newmodel.modules()): 
        if isinstance(m0, nn.Conv2d):
            ...
            #pre = now.clone()
            #the first layer in residual block
            if conv_count % 2 == 0:
                #print('1:')
            ...
            #the second layer in residual block   
            if conv_count % 2 == 1:
                #print('2:')
                #print('mo', m0.weight.data.size())
            ...
            if residual_count == 1:
                ...
                #the residual block   
                    ...
                    #the fisrt conv layer in residual block
                    if residual_count % 2 == 0:
                        ...
                        pre = now.clone()
                        continue
                    #the second conv layer in residual block and the first layer
